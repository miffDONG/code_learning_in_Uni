...
def get_config(pretrained_model_name_or_path,submission_csv):
    cfg = OmegaConf.load('/content/drive/MyDrive/특허분류/baseline/config/pred.yaml')
    cfg.pretrained_model_name_or_path = pretrained_model_name_or_path  # override checkpoint_path with the command line argument
    cfg.submission_csv = submission_csv  # override checkpoint_path with the command line argument
    return cfg
